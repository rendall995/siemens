(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            new swiper_core_Swiper(".bauvorhaben__slider", {
                ...
                navigation: {
                    prevEl: ".bauvorhaben-swiper-button-prev",
                    nextEl: ".bauvorhaben-swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            let mySwiper = new swiper_core_Swiper(".main__slider", {
            ...
            mySwiper.on("slideChange", (function() {
                let activeIndex = mySwiper.activeIndex + 1;
                ...
                let activeIndexDisplay = document.querySelector(".swiper-slide");
                activeIndexDisplay.setAttribute("data-active-index", activeIndex);
                if (activeIndexDisplay.getAttribute("data-active-index") == card1.id) card1.classList.add("active"); else card1.classList.remove("active");
                if (activeIndexDisplay.getAttribute("data-active-index") == card2.id) card2.classList.add("active"); else card2.classList.remove("active");
                if (activeIndexDisplay.getAttribute("data-active-index") == card3.id) card3.classList.add("active"); else card3.classList.remove("active");
                if (activeIndexDisplay.getAttribute("data-active-index") == card4.id) card4.classList.add("active"); else card4.classList.remove("active");
                if (activeIndexDisplay.getAttribute("data-active-index") == card5.id) card5.classList.add("active"); else card5.classList.remove("active");
            }));
        }
    }
